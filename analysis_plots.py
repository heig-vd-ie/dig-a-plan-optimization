...
# Add plots directory to Python path and change to it
optimization_root = os.path.dirname(os.path.abspath(__file__))
plots_dir = os.path.join(optimization_root, "plots")

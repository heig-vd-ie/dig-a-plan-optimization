...
from optimization_model.combined_linear_model.sets import model_sets
from optimization_model.combined_linear_model.parameters import model_parameters
from optimization_model.combined_linear_model.variables import model_variables
from optimization_model.combined_linear_model.constraints import model_constraints
...
class DigAPlan():
    def __init__(
        ...
        self.solver.options['TimeLimit'] = 30 # To insure master binary variable remains binary
    ...
    def __instantiate_model(self):
        ...
        grid_data = {
            None: {
                ...
                "p_max": pl_to_dict(self.edge_data["edge_id", "p_max_pu"]),
